            ...
            <Tbody>
              {students.map((student, i) => (
                <Tr key={student.id}>
                  ...
                  <Td>
                        <button className='p-2 bg-green-700 rounded-md text-white' onClick={(e)=>{axios.get(`http://20.197.17.85:5550/sendApprove?email=${student.email}`);alert('approved successfully!')}} >Approve</button>
                  </Td>
                  <Td>
